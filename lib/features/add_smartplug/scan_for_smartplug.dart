...
import 'package:ecotrack_mobile/features/add_smartplug/smartplug_connection.dart';
import 'package:flutter/services.dart';

// ADD SAVE PREVIOUS WIFI SSID AND PASSWORD TO THE DEVICE

class ScanForSmartPlug extends StatefulWidget {
  const ScanForSmartPlug({Key? key}) : super(key: key);

  @override
  _ScanForSmartPlugState createState() =>
      _ScanForSmartPlugState();
}

class _ScanForSmartPlugState
    extends State<ScanForSmartPlug> {
